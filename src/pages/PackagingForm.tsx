...
const BprDashboard: React.FC<{
  ...
  const onImportZohoSku = useCallback(async () => {
    ...
    try {
      const res = await importPackMaterialFromZohoSku(sku);
      if (res.success && res.data) {
        addToast('success', `Imported "${sku}" from Zoho into Pack Materials.`);
        setZohoSku('');
            ...
            <div className="bg-surface rounded-2xl border border-hairline shadow-sm overflow-hidden hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-5 border-b border-hairline bg-surface-2">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <div className="flex items-center gap-1" title="Fetch an item that exists in Zoho Books by its SKU code and add it to Pack Materials.">
                    <input
                      value={zohoSku}

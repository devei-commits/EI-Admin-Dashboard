...
import LogisticsSchedule from './warehouse/LogisticsSchedule';
import StockCheckRequests from './warehouse/StockCheckRequests';

const VALID_SECTIONS = ['overview', 'locations', 'inventory', 'inbound', 'outbound', 'logistics-schedule', 'stock-check-requests'] as const;

        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl shadow-amber-500/10 border border-white/50 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full py-2.5 text-sm font-medium text-amber-700 bg-amber-50 border border-amber-200 rounded-xl hover:bg-amber-100 hover:border-amber-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >

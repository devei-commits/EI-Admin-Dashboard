  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mt-4 bg-white/60 backdrop-blur-sm rounded-xl border border-amber-200/50 p-4">
          ...
          <div className="text-xs text-gray-600 space-y-1 font-mono bg-gray-50 rounded-lg p-3">
            <p><span className="text-gray-400">Email:</span> superadmin@eisthetic.com</p>
            <p><span className="text-gray-400">Password:</span> SuperAdmin@123</p>
          </div>
        </div>

...
const OrderHub = () => {
 ...
 const getLicenseStatusClass = (status: string) => {
  switch (status) {
   ...
   case 'NO':
    return 'bg-gray-100 text-slate-400 border-gray-200';
   case 'APPLIED':
 ...
 const getPriorityColor = (priority?: 'high' | 'medium' | 'low') => {
  switch (priority) {
   ...
   default: return 'bg-gray-100 text-slate-300 border-gray-300';
  }
 };
     ...
     {tasks.map((task) => (
      <div key={task.id}>
       ...
       {task.id !== 'all' && task.id !== 'goods-receiving' && expandedTask === task.id && (
        <div className="ml-4 mt-1 space-y-1 border-l-2 border-gray-200 pl-2 animate-fadeIn">
         <button
     ...
     {activeSubPage === 'goods-receiving-page' ? (
       ...
       <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex justify-between items-start">
         <div>
          ...
          <p className="text-slate-500 text-sm mt-2">Manage purchase orders, GRNs, and receiving processes</p>
         </div>
        </div>
       </div>
        ...
        <div className="p-4 md:p-6">
         ...
         {activeGoodsReceivingTab === 'print-labels' && (
          <div className="text-center py-8">
           ...
           <p className="text-slate-500">Generate and print product labels</p>
          </div>
         )}
      ...
      <div className="space-y-6">
       ...
       <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-slate-50 rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200">
        ...
        <div className="flex flex-wrap items-center gap-4">
         ...
         <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
           showFilterPanel ? 'bg-gray-100 text-slate-900' : 'bg-gray-100 text-slate-400 hover:bg-gray-200'
          }`}
         >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {(taskStatusFilter !== 'all' || taskPriorityFilter !== 'all' || taskDateFilter.from || taskDateFilter.to) && (
           <span className="bg-slate-800 text-white text-xs px-1.5 py-0.5 rounded-full">Active</span>
          )}
         </button>
         ...
         <div className="flex items-center gap-2">
          ...
          <select
           ...
           className="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-800"
          >
         ...
         <button
          ...
          className={`ml-auto flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
           showWorkloadView ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-slate-400 hover:bg-gray-200'
          }`}
         >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
         ...
         <div className="mt-4 pt-4 border-t border-gray-100 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
           ...
           <select
            ...
            className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-800"
           >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {Object.entries(getTeamWorkload()).map(([team, stats]) => (
           <div key={team} className="bg-slate-50 rounded-lg p-4 border border-gray-200">
          ...
          <div className="flex gap-3">
           <div className="flex-1 relative">
            <input
             ...
             className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-800 focus:border-transparent transition-shadow"
            />
           ...
           <select
            ...
            className="px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-800 bg-white transition-shadow"
           >
           ...
           <div className="overflow-x-auto border border-gray-200 rounded-lg">
            <table className="w-full text-sm">
             <thead className="bg-slate-50 border-b border-gray-200 sticky top-0">
              <tr>
               <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wider border-r border-gray-200 bg-gray-100 sticky left-0 z-10">
                Order ID
               </th>
               ...
               {activeTask === 'bd-tasks' && (
                <>
                 <th className="px-3 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wider bg-blue-50">
                  POC CMT Team
                 </th>
                 <th className="px-3 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wider bg-blue-50">
                  Label Design Status
               ...
               {activeTask === 'rnd-tasks' && (
                <>
                 <th className="px-2 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wider bg-purple-50">
                  R&D Product
                 </th>
                 <th className="px-2 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wider bg-purple-50">
                  Quality
               ...
               .map(order => {
                ...
                return (
                 ...
                 >
                  ...
                  <td className="px-4 py-3 whitespace-nowrap font-semibold text-gray-900 border-r border-gray-200 bg-slate-50 sticky left-0">
                   <div className="flex items-center gap-2">
                    {hasRecentUpdate && (
                  ...
                  <td className="px-4 py-3 whitespace-nowrap">
                   <div className="flex items-center gap-2">
                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-gray-100 text-amber-800">
                  ...
                  <td className="px-4 py-3 whitespace-nowrap">
                   <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${
                    ...
                    order.currentStatus === 'UNDER REVIEW' ? 'bg-gray-100 text-slate-900' :
                    'bg-blue-100 text-blue-700'
                   }`}>
                    {order.currentStatus}
                   </span>
                  ...
                  <td className="px-4 py-3 whitespace-nowrap text-center">
                   <button
                    ...
                    className="inline-flex items-center px-3 py-1.5 bg-slate-800 hover:bg-slate-900 text-white text-xs font-medium rounded-lg transition-colors shadow-sm"
                   >
           ...
           <div key={order.id} className={`bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-all duration-200 ${
             ...
             <div className="flex items-center gap-2">
              ...
              <div className="relative">
               <button
                ...
                className="px-3 py-2 bg-gray-100 hover:bg-gray-200 text-slate-300 text-sm font-medium rounded-lg transition-colors flex items-center gap-1"
               >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                 ...
                 {['Pending', 'In Progress', 'Completed'].map(status => (
                  <button
                   ...
                   className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                    order.currentStatus === status ? 'bg-slate-50 text-slate-900 font-medium' : 'text-slate-300'
                   }`}
                  >
                   {status}
                  </button>
            ...
            {showCommentInput === order.id ? (
             ...
             <button
              ...
              className="mt-3 text-sm text-slate-500 hover:text-slate-800 flex items-center gap-1"
             >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="space-y-6">
       ...
       <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <p className="text-slate-500 text-sm">Monitor and manage {activeTask === 'bd-tasks' ? 'BD tasks' : activeTask === 'rnd-tasks' ? 'RND tasks' : activeTask} tasks and metrics</p>
       </div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
         <div className="flex items-center justify-between">
          <div>
           <p className="text-sm text-slate-500 font-medium uppercase tracking-wide">Active Tasks</p>
          ...
          <div className="text-slate-700 opacity-80">
       ...
       <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="space-y-3">
         {orders
          ...
          .slice(0, 5)
          .map(order => (
           <div key={order.id} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg hover:bg-gray-100 transition-colors">
            <div className="flex-1">
             <button
              onClick={() => {
             ...
             <p className="text-sm text-slate-500">{order.itemName}</p>
            </div>
         ...
         {orders.filter(o => {
          ...
          <p className="text-slate-500 text-center py-8">No tasks in this stage</p>
         )}
        </div>
        <button
         onClick={() => setActiveSubPage('tasks')}
         className="mt-4 w-full px-4 py-2 bg-slate-800 text-white rounded-lg hover:bg-slate-800 hover: transition-all font-medium"
        >
         View All Tasks
        </button>
       </div>
       ...
       {STAGES.map((stage) => {
        ...
        return (
         <div key={stage.id} className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          <div className="text-xs text-slate-500 font-medium uppercase tracking-wide">Stage {stage.id}</div>
        ...
        <div className="bg-white rounded-xl shadow-2xl w-[90%] max-w-4xl max-h-[85vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
         <div className="p-6 border-b border-gray-200 flex items-center justify-between bg-slate-50">
          <div>
           ...
           <p className="text-sm text-slate-400 mt-1">Order No: {selectedOrderDetails.orderNo}</p>
          </div>
          <button 
         ...
         <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(85vh - 120px)' }}>
          <div className="grid grid-cols-2 gap-6">
           ...
           <div className="space-y-4">
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Order No</label>
             <p className="text-sm font-medium text-gray-900">{selectedOrderDetails.orderNo}</p>
            </div>
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Order Type</label>
            ...
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">SKU</label>
             <p className="text-sm font-medium text-gray-900">{selectedOrderDetails.sku}</p>
            </div>
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Item Name</label>
             <p className="text-sm font-medium text-gray-900">{selectedOrderDetails.itemName}</p>
            </div>
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Quantity</label>
             <p className="text-sm font-medium text-gray-900">{selectedOrderDetails.qty}</p>
            </div>
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Unit Rate</label>
           ...
           <div className="space-y-4">
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Order Date</label>
             <p className="text-sm font-medium text-gray-900">{selectedOrderDetails.odrDate}</p>
            </div>
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Est. Delivery Date</label>
             <p className="text-sm font-medium text-gray-900">{selectedOrderDetails.estDelDate}</p>
            </div>
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Current Stage</label>
             <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-100 text-amber-800">
              Stage {selectedOrderDetails.currentStage}
             </span>
            </div>
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">Current Status</label>
             <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
            ...
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">License - EI</label>
             <p className="text-sm font-medium text-gray-900">{selectedOrderDetails.licenseEI}</p>
            </div>
            <div>
             <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">License - Architecture</label>
          ...
          {selectedOrderDetails.comments && (
           <div className="mt-6 pt-6 border-t border-gray-200">
            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-2">Comments</label>
            <div className="bg-slate-50 border border-gray-200 rounded-lg p-3">
             <p className="text-sm text-slate-300">{selectedOrderDetails.comments}</p>
            </div>
           </div>
          )}
          ...
          {selectedOrderDetails.pocForCurrentStatus && (
           <div className="mt-4">
            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-2">POC for Current Status</label>
    ...
    {activeTab === 'orders-review' && (
     <div>
      ...
      <div className="p-4 border-b border-gray-100 flex items-center gap-4">
       <div className="flex-1">
        <label className="block text-xs font-medium text-slate-400 mb-1">Search by Item SKU</label>
        <input
         type="text"
         placeholder="Search..."
         value={searchQuery}
         onChange={(e) => setSearchQuery(e.target.value)}
         className="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-800 focus:border-transparent"
         disabled={isViewOnly}
        />
       </div>
       <div className="w-64">
        ...
        <select
         ...
         onChange={(e) => setStatusFilter(e.target.value)}
         disabled={isViewOnly}
         className={`w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-800 focus:border-transparent bg-white ${
         ...
         <table className="w-full text-xs" style={{ borderCollapse: 'collapse' }}>
          <thead>
           <tr className="border-b border-gray-200">
            <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">
             <input 
              type="checkbox" 
              disabled={isViewOnly}
           ...
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Order Type</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Order No</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Product SKU</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Compatible Item</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Brand Name</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Qty</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Unit Rate</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">ODR Date</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">EST Date</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">POC_CMT_TEAM</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">POC_R&D PRODUCT</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">POC_QUALITY Compliance</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">POC_Label DESIGN</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">RM_REVIEW</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">PM_REVIEW</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">LABEL_DESIGN STATUS</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">LABEL_REVIEW (QC Status)</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">RM_SYNC</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">PM_SYNC</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">License ARCH Status</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">License EI Status</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">MFG Process</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">HOMOGENIZER Process</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Approval Status</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Updatedon</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Upstage_no</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">#Comments</th>
           <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">#S1_ACTIONS__</th>
          </tr>
         </thead>
         <tbody>
          {filteredReviewOrders.map((order) => {
           return (
            <tr key={order.id} className={`border-b border-gray-100 hover:bg-slate-50 transition-colors ${openOrderTypeDropdown === order.id ? 'relative z-[9998]' : ''}`}>
             ...
             <td className="px-3 py-2.5 whitespace-nowrap">
              <div className="relative inline-block">
               <button
                ...
                className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium transition-all ${
                 isViewOnly 
                  ? 'cursor-not-allowed opacity-60 bg-gray-100 text-slate-300'
                ...
                <div className="absolute top-full left-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-2xl z-[9999] min-w-[200px]">
                 {teams.find(t => t.category === 'CMT')?.staff.map((member) => (
                  <button
                   ...
                   className="w-full text-left px-4 py-2.5 text-xs font-medium text-slate-300 hover:bg-slate-50 transition-all border-b border-gray-100 last:border-b-0"
                  >
                   <div className="flex items-center gap-2">
              ...
              <div className="relative inline-block">
               <button
                ...
                className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium transition-all ${
                 isViewOnly 
                  ? 'cursor-not-allowed opacity-60 bg-gray-100 text-slate-300'
                  : 'cursor-pointer bg-gray-100 text-slate-900 hover:bg-gray-200'
                }`}
               >
               ...
               {openPocDropdown?.orderId === order.id && openPocDropdown?.type === 'label' && !isViewOnly && (
                <div className="absolute top-full left-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-2xl z-[9999] min-w-[200px]">
                 {teams.find(t => t.category === 'LABEL_DESIGN')?.staff.map((member) => (
                  ...
                  >
                   <div className="flex items-center gap-2">
                    <div className="w-6 h-6 bg-gray-100 rounded-full flex items-center justify-center text-slate-900 font-bold text-xs">
                     {member.name.charAt(0)}
                    </div>
                    <span>{member.name}</span>
                   </div>
             ...
             <td className="px-3 py-2.5 whitespace-nowrap">
              <button className={order.pmReview === 'add' ? 'text-blue-600 hover:underline' : 'text-slate-300'}>{order.pmReview}</button>
             </td>
             <td className="px-3 py-2.5 whitespace-nowrap">
              <button className={order.labelDesign === 'add' ? 'text-blue-600 hover:underline' : 'text-slate-300'}>{order.labelDesign}</button>
             </td>
             <td className="px-3 py-2.5 whitespace-nowrap">
              <button className="text-blue-600 hover:underline">{order.labelReview}</button>
             </td>
             <td className="px-3 py-2.5 whitespace-nowrap">
              <button className={order.rmSync === 'CG' ? 'text-blue-600 hover:underline' : 'text-slate-300'}>{order.rmSync}</button>
             </td>
             <td className="px-3 py-2.5 whitespace-nowrap">
             ...
             <td className="px-3 py-2.5 whitespace-nowrap text-slate-300">{order.updatedOn || '-'}</td>
             <td className="px-3 py-2.5 whitespace-nowrap text-slate-300">{order.upstageNo || '-'}</td>
             <td className="px-3 py-2.5 whitespace-nowrap text-slate-300">{order.comments}</td>
             <td className="px-3 py-2.5 whitespace-nowrap">
              <div className="flex items-center gap-2">
               <button className="px-3 py-1 text-xs font-medium text-white bg-slate-800 rounded hover:bg-slate-800 transition-colors">
                View
               </button>
        ...
        <div className="bg-white rounded-xl shadow-2xl w-[90%] max-w-4xl max-h-[80vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
         <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          <div>
           ...
           <p className="text-sm text-slate-400 mt-1">Order ID: {viewHistoryOrderId}</p>
          </div>
          <button 
         ...
         <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(80vh - 120px)' }}>
          {auditLogs.length === 0 ? (
           ...
           <div className="space-y-4">
            {auditLogs.map((log) => (
             <div key={log.id} className="border border-gray-200 rounded-lg p-4 hover:bg-slate-50 transition-colors">
              <div className="flex items-start justify-between">
               <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                 ...
                 <span className="text-sm font-semibold text-slate-300">{log.field}</span>
                </div>
               ...
               <div className="text-right ml-4">
                ...
                <p className="text-sm font-medium text-slate-300 mt-1">{log.user}</p>
               </div>
              </div>
             </div>
            ))}
         ...
         <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(85vh - 180px)' }}>
          {selectedOrderIds.size === 0 ? (
           <div className="text-center py-12">
            ...
            <p className="text-lg text-slate-500 font-medium">No orders selected</p>
           ...
           <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-3">
             <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <p className="text-xs text-slate-400 mb-1">Selected Orders</p>
              <p className="text-2xl font-bold text-blue-600">{selectedOrderIds.size}</p>
             </div>
             <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
              <p className="text-xs text-slate-400 mb-1">Total BOM Items</p>
             ...
             <div className="bg-slate-50 border border-gray-200 rounded-lg p-3">
              <p className="text-xs text-slate-400 mb-1">Approved Items</p>
              <p className="text-2xl font-bold text-slate-800">{getSelectedOrdersBOM().filter(i => i.status === 'APPROVED').length}</p>
             </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden">
             <table className="w-full text-sm">
              <thead className="bg-gray-100 border-b border-gray-200">
               <tr>
                <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wide">Order No</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wide">Item Name</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wide">Component</th>
                <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Qty</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wide">Unit</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wide">Supplier</th>
                <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Unit Cost</th>
                <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Total Cost</th>
                <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Status</th>
               </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
               {getSelectedOrdersBOM().map((item) => (
                <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                 ...
                 <td className="px-4 py-3 text-sm text-slate-300 max-w-xs truncate">{item.itemName}</td>
                 <td className="px-4 py-3 text-sm text-slate-300">{item.componentName}</td>
                 ...
                 <td className="px-4 py-3 text-sm text-slate-300">{item.supplier}</td>
                 <td className="px-4 py-3 text-sm text-center text-slate-300">₹{item.unitCost.toFixed(2)}</td>
          ...
          <div className="space-y-4">
           <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            ...
            <div className="grid grid-cols-3 gap-4">
             ...
             <div>
              <p className="text-xs text-slate-400 mb-1">Avg Unit Rate</p>
           ...
           <p className="text-sm text-slate-400 text-center mt-8">Detailed price analysis will appear here</p>
          </div>
         </div>
         <div className="p-4 border-t border-gray-200 bg-slate-50 flex justify-end gap-3">
          <button
         ...
         <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(85vh - 180px)' }}>
          <div className="space-y-4">
           ...
           <div className="border border-gray-200 rounded-lg overflow-hidden">
            <table className="w-full text-sm">
             <thead className="bg-gray-100 border-b border-gray-200">
              <tr>
               <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wide">Component</th>
               <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Current Stock</th>
               <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Required Stock</th>
               <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Unit</th>
               <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wide">Supplier</th>
               <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Lead Time (Days)</th>
               <th className="px-4 py-3 text-left text-xs font-semibold text-slate-300 uppercase tracking-wide">Notes</th>
               <th className="px-4 py-3 text-center text-xs font-semibold text-slate-300 uppercase tracking-wide">Action</th>
              </tr>
             </thead>
             <tbody className="divide-y divide-gray-200">
           ...
           <div className="grid grid-cols-3 gap-3 mt-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
             <p className="text-xs text-slate-400 mb-1">Total Components</p>
             <p className="text-2xl font-bold text-blue-600">{stockPlanData.length}</p>
            </div>
            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
             <p className="text-xs text-slate-400 mb-1">Current Stock Total</p>
             <p className="text-2xl font-bold text-green-600">{stockPlanData.reduce((sum, item) => sum + item.currentStock, 0)}</p>
            </div>
            <div className="bg-slate-50 border border-gray-200 rounded-lg p-3">
             <p className="text-xs text-slate-400 mb-1">Required Stock Total</p>
             <p className="text-2xl font-bold text-slate-800">{stockPlanData.reduce((sum, item) => sum + item.requiredStock, 0)}</p>
            </div>
           </div>
          </div>
         </div>
       ...
       <button
        ...
        className={`px-6 py-3 text-sm font-medium transition-all ${
         purchasePlanSubTab === 'po-plan'
          ? 'border-b-2 border-slate-800 text-slate-800 bg-white'
      ...
      <div className="p-6">
       {purchasePlanSubTab === 'po-plan' && (
        <div>
         <div className="mb-4">
          ...
          <p className="text-sm text-slate-400">Purchase Order Plan</p>
         </div>
         ...
         <div className="p-4 border border-gray-100 rounded-xl bg-white flex items-center gap-4 mb-4">
          ...
          <div className="pt-5">
           <button className="px-6 py-2 bg-slate-800 text-white text-sm font-medium rounded-lg hover:bg-slate-800 transition-colors shadow-sm">
            Filter Items
           </button>
          </div>
         </div>
         ...
         <div className="overflow-x-auto border border-gray-100 rounded-xl bg-white relative z-0">
          {loading ? (
           ...
           <table className="w-full relative" style={{ borderCollapse: 'collapse', position: 'relative' }}>
            <thead>
             <tr className="border-b border-gray-200">
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-0 z-40 bg-white">
               <input type="checkbox" className="rounded border-gray-300 w-4 h-4" />
              </th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-12 z-40 bg-white">ID</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-28 z-40 bg-white">Order No</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-64 z-20 bg-white">SKU</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-80 z-20 bg-white">Item Name</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Qty</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Rate</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Req</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">ODR_Date</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">EST_Date</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">COM_Date</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">#SYNC</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">INV PLAN</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Transition Date</th>
              <th className="px-4 py-3 text-center text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">License ARCH Status</th>
              <th className="px-4 py-3 text-center text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">License EI Status</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">MFG Process</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">HMG Status</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">MRP_Status</th>
              <th className="px-4 py-3 text-center text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">#POC</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">#Comments</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Updated_Dt</th>
              <th className="px-4 py-3 text-center text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap bg-white">Action</th>
             </tr>
            </thead>
            <tbody>
             {poPlanOrders.map((order) => (
              <tr key={order.id} className="border-b border-gray-100 hover:bg-slate-50 transition-colors">
               <td className="px-4 py-3.5 sticky left-0 z-30 bg-white hover:bg-slate-50">
                <input type="checkbox" className="rounded border-gray-300 w-4 h-4" />
               </td>
               ...
               <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.odrDate}</td>
               <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.estDelDate}</td>
               <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.comDate}</td>
                ...
                <div className="relative inline-block text-left">
                 ...
                 {openLicenseDropdown?.orderId === order.id && openLicenseDropdown?.type === 'arch' && (
                  <div ref={licenseDropdownRef} data-license-dropdown="true" className="absolute z-50 mt-2 w-64 rounded-lg border border-gray-200 bg-white shadow-lg p-3">
                   <p className="text-[11px] font-semibold text-slate-400 uppercase mb-2">Select License Status..</p>
                   <div className="space-y-2">
                    <div className="flex items-center gap-2">
                     <label className="text-[11px] text-slate-500">MFG Unit</label>
                     <select
                    ...
                    <div className="flex items-center gap-2">
                     <label className="text-[11px] text-slate-500">LDIS.No</label>
                     <input
                      className="flex-1 border border-gray-300 rounded px-2 py-1 text-xs"
                      placeholder="LDIS.No"
               ...
               <td className="px-4 py-3.5 whitespace-nowrap text-center">
                <div className="relative inline-block text-left">
                 ...
                 {openLicenseDropdown?.orderId === order.id && openLicenseDropdown?.type === 'ei' && (
                  <div ref={licenseDropdownRef} data-license-dropdown="true" className="absolute z-50 mt-2 w-64 rounded-lg border border-gray-200 bg-white shadow-lg p-3">
                   <p className="text-[11px] font-semibold text-slate-400 uppercase mb-2">Select License EI Status..</p>
                   <div className="space-y-2">
                    <div className="flex items-center gap-2">
                     <label className="text-[11px] text-slate-500">MFG Unit</label>
                     <select
                    ...
                    <div className="flex items-center gap-2">
                     <label className="text-[11px] text-slate-500">License No.</label>
                     <input
                      className="flex-1 border border-gray-300 rounded px-2 py-1 text-xs"
                ...
                <div className="relative inline-block text-left">
                 ...
                 {openHmgDropdown === order.id && (
                  <div ref={hmgDropdownRef} data-hmg-dropdown="true" className="absolute z-50 mt-2 w-56 rounded-lg border border-gray-200 bg-white shadow-lg p-3">
                   <p className="text-[11px] font-semibold text-slate-400 uppercase mb-2">Select HMG Status</p>
                   <select
                ...
                <div className="relative inline-block text-left">
                 ...
                 {openMrpDropdown === order.id && (
                  <div ref={mrpDropdownRef} data-mrp-dropdown="true" className="absolute z-50 mt-2 w-48 rounded-lg border border-gray-200 bg-white shadow-lg p-3">
                   <p className="text-[11px] font-semibold text-slate-400 uppercase mb-2">Select MRP Review Status</p>
                   <select
               ...
               <td className="px-4 py-3.5 whitespace-nowrap text-center">
                <button
                 className="p-1.5 text-slate-400 hover:text-gray-900 hover:bg-gray-100 rounded transition-colors"
                 title="Action"
                >
                ...
                <div className="fixed inset-0 z-50 bg-transparent flex items-center justify-center" onClick={() => setOpenCommentModal(null)}>
                 ...
                 >
                  ...
                  <textarea
                   ...
                   className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-800 resize-none"
                   rows={4}
                   placeholder="Enter your comment here..."
                  />
                  <div className="flex items-center gap-2 mt-4">
                   <button
                    className="flex-1 px-4 py-2 bg-slate-800 text-white rounded hover:bg-slate-800 transition-colors font-medium"
                    onClick={() => saveComment(openCommentModal)}
                   >
                    Save
                   </button>
                   <button
                    className="flex-1 px-4 py-2 bg-gray-300 text-slate-300 rounded hover:bg-gray-400 transition font-medium"
             ...
             {!poPlanOrders.length && (
              <tr>
               <td className="px-4 py-10 text-center text-sm text-slate-500" colSpan={24}>
       ...
       {purchasePlanSubTab === 'rev-1' && (
        <div>
         ...
         <p className="text-slate-400">Revision 1 content will be displayed here.</p>
        </div>
       )}
      </div>
     </div>
     ...
     <div>
      ...
      <div className="overflow-x-auto">
       {getConnectivityTrackerOrders().length === 0 && !showAddConnectivityRow ? (
        <div className="flex items-center justify-center py-12">
         <p className="text-slate-500 text-sm">No records available. Add new records or create manually.</p>
        </div>
       ) : (
         <table className="w-full" style={{ borderCollapse: 'collapse' }}>
         <thead>
          <tr className="border-b border-gray-200 bg-slate-50">
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-0 z-20 bg-slate-50">ID</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-12 z-20 bg-slate-50">Order No</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-28 z-20 bg-slate-50">SKU</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-48 z-20 bg-slate-50">Item Name</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Qty</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Rate</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Req</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">ODR Date</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">EST. Date</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">COM Date</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">INV. Can_di</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Transition</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">MFG_Loc</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">License ARCH</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">License EI</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">MFG Process</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">HMG Process</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">FG_PLAN_QTY</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">MFG_UNIT</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">EST_MFG DATE</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">TANK_CODE</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">FILLING_UNI_CDE</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">EST_FILLING_UNIT</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">*POC_</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">*Comments</th>
           <th className="px-4 py-3 text-center text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Actions</th>
          </tr>
         </thead>
         <tbody>
          {/* Comment Modal */}
            ...
            <tr key={order.id} className="border-b border-gray-100 hover:bg-slate-50 transition-colors">
             ...
             <td className="px-4 py-3.5 whitespace-nowrap text-sm">
              <input
               ...
               className="w-full px-2 py-1 text-sm border border-gray-300 rounded text-slate-300 bg-white focus:border-slate-800 focus:ring-1 focus:ring-slate-800 focus:outline-none"
              />
             </td>
             <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.odrDate}</td>
             <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.estDelDate}</td>
             ...
             <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{transitionDate}</td>
             <td className="px-4 py-3.5 whitespace-nowrap text-sm">
              <select
               defaultValue={recordData.mfgLoc || 'ARCHEESH LAB'}
               onChange={(e) => updateConnectivityRecord(order.id, 'mfgLoc', e.target.value)}
               className="px-2 py-1 text-sm border border-gray-300 rounded text-slate-300 bg-white focus:border-slate-800 focus:ring-1 focus:ring-slate-800 focus:outline-none"
              >
             ...
             <td className="px-4 py-3.5 whitespace-nowrap text-center">
              <span className={`inline-block px-2 py-0.5 rounded-full text-xs ${order.licenseArch === 'yes' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-slate-400'}`}>
               {order.licenseArch}
              </span>
             </td>
             <td className="px-4 py-3.5 whitespace-nowrap text-center">
              <span className={`inline-block px-2 py-0.5 rounded-full text-xs ${order.licenseEI === 'yes' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-slate-400'}`}>
               {order.licenseEI}
              </span>
             </td>
             <td className="px-4 py-3.5 whitespace-nowrap text-sm">
             ...
             <td className="px-4 py-3.5 whitespace-nowrap text-sm">
              <span 
               onClick={() => openHmgEditor(order.id)}
               className="inline-block px-2 py-1 rounded text-xs font-medium bg-gray-100 text-slate-900 cursor-pointer hover:bg-gray-200"
              >
               {getHmgStatusLabel(order.id)}
              </span>
             </td>
             ...
             <td className="px-4 py-3.5 whitespace-nowrap">
              <input
               ...
               className="px-2 py-1 text-sm border border-gray-300 rounded text-slate-300 bg-white focus:border-slate-800 focus:ring-1 focus:ring-slate-800 focus:outline-none cursor-pointer"
              />
             </td>
             <td className="px-4 py-3.5 whitespace-nowrap text-sm">
              <select
               ...
               {openPocModal === order.id && pocModalOrder && (
                <div className="absolute z-50 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg p-4 right-0">
                 ...
                 <ul className="space-y-2 text-[11px]">
                  <li>
                   <span className="font-medium text-slate-300">CM_TEAM: </span>
                   <span className="text-slate-400">TEJA</span>
                  </li>
                  <li>
                   <span className="font-medium text-slate-300">R&D PRODUCT: </span>
                   <span className="text-slate-400">(id: 12, name: "BHAVYA")</span>
                  </li>
                  <li>
                  ...
                  <li>
                   <span className="font-medium text-slate-300">QUALITY PRODUCT: </span>
                   <span className="text-slate-400">(id: 57, name: "SHIVA KUMAR")</span>
                  </li>
                  <li>
                   <span className="font-medium text-slate-300">QUALITY COMPLIANCE: </span>
                   <span className="text-slate-400">-</span>
                  </li>
                  <li>
                   <span className="font-medium text-slate-300">LABEL DESIGN: </span>
                   <span className="text-slate-400">TARUN</span>
                  </li>
                 </ul>
                </div>
               )}
             ...
             <td className="px-4 py-3.5 text-sm">
              <button
               onClick={() => openCommentEditor(order.id)}
               className="px-2 py-1 text-slate-800 hover:text-amber-900 hover:bg-gray-100 rounded transition-colors font-medium"
              >
          ...
          {showAddConnectivityRow && newConnectivityRecord && (
           <tr className="border-b border-gray-100 bg-green-50 hover:bg-green-50 transition-colors">
            ...
            <td colSpan={24} className="px-4 py-3.5 text-center text-sm text-slate-400">
      ...
      <div className="p-4 border-t border-gray-100 bg-slate-50">
       <div className="grid grid-cols-5 gap-4">
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200">
         <p className="text-xs text-slate-400 uppercase font-semibold">License ARCH</p>
         <p className="text-2xl font-bold text-purple-600 mt-2">{getConnectivityTrackerOrders().filter(o => o.licenseArch === 'yes').length}</p>
        </div>
        <div className="bg-white p-4 rounded-lg border border-gray-200">
         <p className="text-xs text-slate-400 uppercase font-semibold">License EI</p>
         <p className="text-2xl font-bold text-slate-800 mt-2">{getConnectivityTrackerOrders().filter(o => o.licenseEI === 'yes').length}</p>
        </div>
       </div>
      </div>
     </div>
     ...
     <div>
      ...
      <div className="p-4 border-b border-gray-100 bg-slate-50">
       <div className="flex items-center gap-6">
        <span className="text-sm font-semibold text-slate-300">WAREHOUSE:</span>
        <div className="flex items-center gap-6">
         ...
         <label className="flex items-center gap-2 cursor-pointer">
          <input
           ...
           className="w-4 h-4"
          />
          <span className="text-sm text-slate-300">ARCHEESH LAB</span>
         </label>
         <label className="flex items-center gap-2 cursor-pointer">
          <input
           type="radio"
           ...
           className="w-4 h-4"
          />
          <span className="text-sm text-slate-300">EI FACTORY</span>
         </label>
        </div>
       </div>
      </div>
      ...
      <div className="overflow-x-auto">
       {orders.length === 0 ? (
        <div className="flex items-center justify-center py-12">
         <p className="text-slate-500 text-sm">No records available.</p>
        </div>
       ) : (
        <table className="w-full" style={{ borderCollapse: 'collapse' }}>
         <thead>
          <tr className="border-b border-gray-200 bg-slate-50">
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-0 z-20 bg-slate-50">ID</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-12 z-20 bg-slate-50">Order No</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-28 z-20 bg-slate-50">Item SKU</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap sticky left-48 z-20 bg-slate-50">Item Name</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Order Qty</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Order Rate</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Req</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Material Request</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">ODR_Date</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">EST_Date</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">COM_Date</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Transition_Date</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">FG_PLAN_QTY</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">License ARCH</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">License EI</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">MFG_Process</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">HMG Process</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">PRODUCT</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">PACKING</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">MFG_UNIT</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">EST_MFG</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">TANK_CODE</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">FILLING *line code*</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">EST_FILLING DATE</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">RM_T Req_dt</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">PM_T Req_dt</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Disp_sheet</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">*Comments</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">*POC</th>
           <th className="px-4 py-3 text-center text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Action</th>
          </tr>
         </thead>
         <tbody>
          {orders.filter((order) => {
           ...
           <tr key={order.id} className="border-b border-gray-100 hover:bg-slate-50 transition-colors">
            ...
            <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.unitRate}</td>
            <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">-</td>
            <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">CRD</td>
            <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.odrDate}</td>
            <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.estDelDate}</td>
            <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">{order.comDate}</td>
            <td className="px-4 py-3.5 whitespace-nowrap text-sm text-slate-300">-</td>
      ...
      <div className="p-4 border-b border-gray-100 bg-slate-50">
       ...
       <div>
        <input
         ...
         className="px-3 py-2 border border-gray-300 rounded text-sm focus:outline-none focus:border-slate-800 focus:ring-1 focus:ring-slate-800 w-64"
        />
       </div>
      </div>
        ...
        <table className="w-full" style={{ borderCollapse: 'collapse' }}>
         <thead>
          <tr className="border-b border-gray-200 bg-slate-50">
           ...
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">RM_T Req_dt</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">PM_T Req_dt</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">PM_DISPENSE</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">RM_DISPENSE</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">BUNDLE_NO</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">BUNDLE_QTY</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">*POC</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Disp_sheet</th>
           <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">*Comments</th>
           <th className="px-4 py-3 text-center text-xs font-semibold text-slate-400 uppercase tracking-wide whitespace-nowrap">Complete Order</th>
          </tr>
         </thead>
         <tbody>
          {orders
           ...
           <tr key={order.id} className="border-b border-gray-100 hover:bg-slate-50 transition-colors">
            ...
            <td className="px-4 py-3.5 whitespace-nowrap text-center">
             <button
              ...
              className="px-3 py-1.5 bg-slate-800 text-white text-xs font-medium rounded hover:bg-slate-800 transition-colors"
             >
              Bundle
             </button>
              ...
              <div className="fixed inset-0 z-50 bg-transparent flex items-center justify-center" onClick={() => setBundleModalOpen(null)}>
               ...
               >
                ...
                <input
                 ...
                 className="w-full px-3 py-2 border border-gray-300 rounded mb-4 focus:outline-none focus:border-slate-800 focus:ring-1 focus:ring-slate-800"
                />
                <div className="flex gap-3">
                 <button
                  onClick={() => {
                 ...
                 <button
                  ...
                  className="flex-1 px-4 py-2 bg-gray-300 text-slate-300 rounded hover:bg-gray-400 transition-colors font-medium"
                 >
                  Cancel
                 </button>
                </div>
      ...
      <div className="sticky top-0 bg-slate-800 text-white p-6 rounded-t-2xl">
       <div className="flex items-start justify-between">
        <div>
         ...
         <p className="text-gray-100">{selectedTaskDetail.itemName}</p>
        </div>
        <button
      ...
      <div className="p-6 space-y-6">
       ...
       <div className="grid grid-cols-2 gap-4">
        <div className="bg-slate-50 rounded-lg p-4">
         <p className="text-sm text-slate-500 font-medium mb-1">Order Type</p>
         <p className="text-gray-800 font-semibold">{selectedTaskDetail.orderType}</p>
        </div>
        <div className="bg-slate-50 rounded-lg p-4">
         <p className="text-sm text-slate-500 font-medium mb-1">SKU</p>
        ...
        <div className="bg-slate-50 rounded-lg p-4">
         <p className="text-sm text-slate-500 font-medium mb-1">Unit Rate</p>
       ...
       <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-slate-50 rounded-lg p-4 border border-gray-200">
         <p className="text-sm text-slate-800 font-medium mb-1">Est. Delivery Date</p>
         <p className="text-gray-800 font-semibold">
       ...
       <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
        ...
        {selectedTaskDetail.pocForCurrentStatus && (
         <p className="text-sm text-slate-400 mt-2">POC: {selectedTaskDetail.pocForCurrentStatus}</p>
        )}
       </div>
       ...
       {/* Stage Progress */}
       <div className="bg-slate-50 rounded-lg p-4">
        <p className="text-sm text-slate-400 font-medium mb-3">Stage Progress</p>
        <div className="flex items-center gap-2">
       ...
       {selectedTaskDetail.comments && (
        <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
         ...
         <p className="text-slate-300">{selectedTaskDetail.comments}</p>
        </div>
       )}
       ...
       {selectedTaskDetail.activityLog && selectedTaskDetail.activityLog.length > 0 && (
        <div className="bg-slate-50 rounded-lg p-4 border border-gray-200">
         <div className="flex items-center justify-between mb-4">
          <p className="text-sm text-slate-300 font-medium">Activity Timeline</p>
          <span className="text-xs text-slate-500">{selectedTaskDetail.activityLog.length} activities</span>
         </div>
       ...
       <div className="bg-white rounded-lg p-4 border border-gray-200">
        <p className="text-sm text-slate-300 font-medium mb-3">Add Comment</p>
        <div className="flex gap-2">
         <input
          type="text"
          value={newComment}
       ...
       {selectedTaskDetail.attachments && selectedTaskDetail.attachments.length > 0 && (
        <div className="bg-slate-50 rounded-lg p-4 border border-gray-200">
         <div className="flex items-center justify-between mb-3">
          <p className="text-sm text-slate-300 font-medium">Attachments</p>
          <span className="text-xs text-slate-500">{selectedTaskDetail.attachments.length} files</span>
         </div>
         <div className="space-y-2">
          {selectedTaskDetail.attachments.map((attachment) => (
           <div key={attachment.id} className="flex items-center gap-3 bg-white rounded-lg p-3 border border-gray-200">
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
             ...
             attachment.type === 'ai' ? 'bg-orange-100 text-slate-800' :
            ...
            <div className="flex-1 min-w-0">
             ...
             <p className="text-xs text-slate-500">{attachment.size} • Uploaded {attachment.uploadedAt}</p>
            </div>
       ...
       <div className="flex gap-3 pt-4 border-t border-gray-200">
        <button
         ...
         className="flex-1 px-4 py-3 bg-slate-800 text-white rounded-lg hover:bg-slate-800 hover: transition-all font-medium shadow-lg hover:shadow-xl"
        >
         View in Dashboard
        </button>
        <button
        ...
        <button
         onClick={() => setSelectedTaskDetail(null)}
         className="px-6 py-3 bg-gray-200 text-slate-300 rounded-lg hover:bg-gray-300 transition-colors font-medium"
        >
         Close
        </button>
       </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
     <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
      ...
      <div className="p-6 space-y-4">
       ...
       <div>
        <label className="block text-sm font-medium text-slate-300 mb-2">Select Team Member</label>
        <select
         id="reassign-member"
         className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
       ...
       <div className="space-y-6">
        {teams.map((team) => (
         <div key={team.id} className="border border-gray-200 rounded-lg p-5 bg-gradient-to-br from-white to-gray-50">
          <div className="flex items-center justify-between mb-4">
           <div className="flex items-center gap-3">
            ...
            <div>
             {editingTeamName === team.id ? (
              <div className="flex items-center gap-2">
               ...
               <button
                ...
                className="p-1 text-gray-400 hover:text-slate-400"
               >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
             ...
             <p className="text-xs text-slate-500">{team.staff.length} staff members</p>
            </div>
           </div>
           <button 
          ...
          {/* Team Lead */}
          <div className="mb-4">
           <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-2">Team Lead</label>
           {team.lead ? (
            <div className="flex items-center gap-3 p-3 bg-indigo-50 border border-indigo-200 rounded-lg">
             ...
             <div className="flex-1">
              ...
              <p className="text-xs text-slate-500">{team.lead.email}</p>
             </div>
             <button 
            ...
            <button 
             ...
             className="w-full p-3 border-2 border-dashed border-gray-300 rounded-lg text-sm text-slate-500 hover:border-indigo-400 hover:text-indigo-600 transition-colors"
            >
             + Assign Team Lead
            </button>
           )}
          ...
          {/* Staff Members */}
          <div>
           <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wide mb-2">Staff Members</label>
           <div className="space-y-2">
            {team.staff.map((member) => (
             <div key={member.id} className="flex items-center gap-3 p-2.5 bg-white border border-gray-200 rounded-lg hover:border-indigo-300 transition-colors">
              <div className="w-7 h-7 bg-gray-300 rounded-full flex items-center justify-center text-slate-300 font-bold text-xs">
               {member.name.charAt(0)}
              </div>
              <div className="flex-1">
            ...
            <button 
             ...
             className="w-full p-2.5 border-2 border-dashed border-gray-300 rounded-lg text-xs text-slate-500 hover:border-indigo-400 hover:text-indigo-600 transition-colors"
            >
             + Add Staff Member
            </button>
           </div>

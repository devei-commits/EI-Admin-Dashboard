        ...
        <div className="p-4 md:p-6">
          ...
          {activeTab === 'po-requests' && (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">PO Requests</h3>
              <p className="text-gray-500">View and manage purchase order requests</p>
            </div>
          )}
          ...
          {activeTab === 'issued-pos' && (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Issued P.O.s</h3>
              <p className="text-gray-500">Track all issued purchase orders</p>
            </div>
          )}

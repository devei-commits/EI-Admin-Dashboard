        ...
        <div className="space-y-4 sm:space-y-6 p-3 sm:p-6">
            ...
            <div className="flex gap-2 sm:gap-3">
                <button
                    ...
                    className={`px-3 sm:px-6 py-2 sm:py-2.5 rounded-lg font-medium transition-all flex items-center gap-1 sm:gap-2 text-sm sm:text-base ${
                        viewMode === 'dashboard'
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                        <div className="flex border-b border-gray-200">
                            <button
                                ...
                                className={`flex-1 px-3 sm:px-6 py-2 sm:py-3 font-medium transition-all text-sm sm:text-base ${
                                    activeTab === 'sales'
                                ...
                                <div>
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 sm:mb-6">
                                        ...
                                        <div className="flex gap-2 sm:gap-3 w-full sm:w-auto">
                                            ...
                                            <button onClick={() => { setOrderType('SO'); setViewMode('form'); }} className="flex-1 sm:flex-none bg-gradient-to-r from-amber-500 to-orange-500 text-white px-3 sm:px-4 py-2 rounded-lg hover:from-amber-600 hover:to-orange-600 transition-all flex items-center justify-center gap-2 text-sm sm:text-base">
                                                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                {filteredSalesOrders.map((order) => (
                                                    <div key={order.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                                        <div className="flex justify-between items-start mb-3">
                                                            ...
                                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${order.status === 'Draft' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'}`}>
                                                                {order.status}
                                                            </span>
                                                        </div>

...
interface PurchaseTabProps {
  ...
  onCreatePO: () => void;
  setDraftSplitModalId: (id: string) => void;
  setDelayImpactModalPoId: (id: string) => void;
}
...
const PurchaseTab: React.FC<PurchaseTabProps> = ({
  ...
  setShowFiltersOff,
  onCreatePO,
  setDraftSplitModalId,
  setDelayImpactModalPoId,
}) => {
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 sm:mb-6">
        ...
        <div className="flex gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <button onClick={onCreatePO} className="flex-1 sm:flex-none bg-blue-500 text-white px-3 sm:px-4 py-2 rounded-lg transition-all flex items-center justify-center gap-2 text-sm sm:text-base">

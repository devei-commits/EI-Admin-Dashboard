            ...
            <table className="w-full table-fixed min-w-275 text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  <th scope="col" className="w-[9%] text-left py-3 px-3 font-semibold text-gray-700 text-xs uppercase tracking-wider">Order ID</th>
                  <th scope="col" className="w-[5%] text-left py-3 px-3 font-semibold text-gray-700 text-xs uppercase tracking-wider">Type</th>
                  <th scope="col" className="w-[12%] text-left py-3 px-3 font-semibold text-gray-700 text-xs uppercase tracking-wider">Customer</th>

  ...
  return (
   <div className="flex items-center justify-center min-h-screen bg-surface-2">
    <div className="flex flex-col items-center gap-4">
     <div className="w-12 h-12 border-4 border-border border-t-amber-500 rounded-full animate-spin"></div>
...
export const AccessDenied: React.FC<{ message?: string }> = ({ 
 ...
 return (
   ...
   <div className="bg-err-soft border border-err rounded-xl p-8 text-center max-w-md">
    <div className="w-16 h-16 mx-auto mb-4 bg-err-soft rounded-full flex items-center justify-center">
     <svg className="w-8 h-8 text-err" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
     </svg>
    </div>
    <h3 className="text-lg font-semibold text-err mb-2">Access Denied</h3>
    <p className="text-err text-sm">{message}</p>

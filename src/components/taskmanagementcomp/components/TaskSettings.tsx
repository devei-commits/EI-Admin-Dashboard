 ...
 return (
  <div className="space-y-6">
   ...
   <div className="bg-slate-800 rounded-2xl p-6 text-white shadow-lg">
    <div className="flex items-center gap-4">
     ...
     <div>
      ...
      <p className="text-gray-100 mt-1">Manage your task preferences</p>
     </div>
    </div>
   </div>
   ...
   <div className="flex justify-end">
    <button className="px-6 py-2 bg-slate-800 text-white rounded-lg font-medium hover:bg-slate-800 hover: transition-colors flex items-center gap-2">

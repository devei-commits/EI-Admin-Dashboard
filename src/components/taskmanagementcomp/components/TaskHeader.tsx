...
export function TaskHeader({ onMenuToggle, isSidebarOpen, currentUser }: TaskHeaderProps) {
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-gradient-to-r from-amber-600 to-orange-500 shadow-lg z-50">
      <div className="flex items-center justify-between h-full px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:block">
              ...
              <p className="text-xs text-amber-100">EI Staff Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-amber-200" />
            <input
              type="text"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-white/20">
            ...
            <div className="hidden md:block text-right">
              ...
              <p className="text-xs text-amber-100 capitalize">{currentUser?.role || 'Staff'}</p>
            </div>
          </div>
        </div>
      </div>

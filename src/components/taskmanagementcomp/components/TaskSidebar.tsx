...
export function TaskSidebar({ currentRole, activeView, onViewChange, isOpen, onClose }: TaskSidebarProps) {
 ...
 return (
  <>
   ...
   {/* Sidebar */}
   <aside
    className={`fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-white border-r border-gray-200 shadow-xl z-40 transition-transform duration-300 ${
   ...
   >
    ...
    <div className="p-4 border-b border-gray-200">
     ...
     <p className="text-xs text-slate-800 mt-1 font-medium">Task Management System</p>
    </div>
    ...
    {/* Footer */}
    <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 bg-gradient-to-t bg-slate-800 to-white">
     <div className="text-center">
      <p className="text-xs text-gray-500">Task Management v1.0</p>
      <p className="text-xs text-slate-800 font-medium">© Eisthetic Industries</p>
     </div>
    </div>
   </aside>
  </>

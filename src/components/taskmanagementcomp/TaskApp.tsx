...
function TaskAppContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50">
      ...
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-amber-100 shadow-sm z-40">
        <div className="h-full px-4 md:px-6 flex items-center justify-between">
          {/* Left side - Logo and Title */}
          <div className="flex items-center gap-4">
            <img src={eilogofull} alt="EI Logo" className="h-8 w-auto" />
            <div className="hidden md:block h-8 w-px bg-amber-200" />
          ...
          <div className="flex items-center gap-3">
            {/* Notifications */}
            <button className="relative p-2 text-gray-500 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors">
            ...
            <div className="relative">
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-amber-100 py-2 z-50">
                  ...
                  <button className="w-full px-4 py-2 text-left text-sm text-gray-600 hover:bg-amber-50 flex items-center gap-2">

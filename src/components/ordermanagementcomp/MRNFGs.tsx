  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="bg-gradient-to-r from-amber-100 to-orange-100 p-4 border-b border-amber-300">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-600">{selectedMRNs.length} Selected</span>
          </div>
        ...
        <table className="w-full text-xs border-collapse">
          <thead>
            <tr className="bg-amber-200 sticky top-0">
              ...
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">#MRN_ID</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">Order No</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">To WH_Name</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">From WH_Name</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">MRN_DATE</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">PreparedBy</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">Addedon_Dt</th>
          ...
          <tbody>
            {paginatedData.map((item, idx) => (
              <tr key={startIndex + idx} className="hover:bg-amber-50 transition-colors">
                ...
                <td className="border border-amber-300 p-2 font-medium whitespace-nowrap">{item.mrnId || '-'}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.orderNo}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.toWhName || '-'}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.fromWhName || '-'}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.mrnDate || '-'}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.preparedBy || '-'}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.addedonDt || '-'}</td>
      ...
      <div className="md:hidden space-y-4 p-4">
        {paginatedData.map((item, idx) => (
          <div key={startIndex + idx} className="border border-amber-300 rounded-lg p-4 bg-white shadow-sm">
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex-1 ml-3">
                ...
                <p className="text-xs text-gray-600 mt-1">MRN ID: {item.mrnId || '-'}</p>
              </div>
            </div>
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">From Warehouse:</span>
      ...
      {paginatedData.length === 0 && (
        <div className="text-center py-8">
          <p className="text-gray-500">No MRN/FG records found</p>
        </div>
      )}

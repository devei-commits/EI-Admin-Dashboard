...
const OrderHub: React.FC = () => {
 return (
  <div className="space-y-8">
   <div className="bg-slate-50 rounded-xl p-7 border border-gray-100">
    <h2 className="text-3xl font-bold text-gray-800 mb-3 tracking-tight">Order Hub</h2>
    <p className="text-slate-300 leading-relaxed tracking-wide">Centralized order management and tracking system</p>
   </div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
     <div className="flex items-center justify-between">
      <div>
       <p className="text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">Total Orders</p>
    ...
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
     <div className="flex items-center justify-between">
      <div>
       <p className="text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">Pending</p>
    ...
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
     <div className="flex items-center justify-between">
      <div>
       <p className="text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">Processing</p>
    ...
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
     <div className="flex items-center justify-between">
      <div>
       <p className="text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">Completed</p>
   ...
   <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-7">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
     <button className="flex items-center gap-3 px-5 py-4 bg-slate-800 text-white rounded-lg hover:bg-slate-800 hover: transition-all shadow-md font-medium tracking-wider">
     ...
     <button className="flex items-center gap-3 px-5 py-4 bg-gray-100 text-slate-300 rounded-lg hover:bg-gray-200 transition-all font-medium tracking-wider">
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

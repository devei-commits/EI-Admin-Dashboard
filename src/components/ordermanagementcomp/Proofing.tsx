    ...
    <div className="w-full h-full flex flex-col">
        ...
        <table className="w-full text-xs border-collapse">
          <thead>
            <tr className="bg-amber-200 sticky top-0">
              ...
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">Item_SKU</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">QC-Type</th>
              ...
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">Created By</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">Verified Dt</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">Verified By</th>
              <th className="border border-amber-300 p-2 text-left font-semibold whitespace-nowrap">Proofing Status</th>
          ...
          <tbody>
            {filteredData.map((item) => (
              <tr key={item.id} className="hover:bg-amber-50 transition-colors">
                ...
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.qcType}</td>
                <td className="border border-amber-300 p-2 max-w-xs truncate" title={item.itemName}>
                  {item.itemName}
                </td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.comments || '-'}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.createdDt}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.createdBy}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.verifiedDt}</td>
                <td className="border border-amber-300 p-2 whitespace-nowrap">{item.verifiedBy}</td>
          ...
          <div key={item.id} className="border border-amber-300 rounded-lg p-4 bg-white shadow-sm">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between">
                <span className="text-gray-600">QC Type:</span>
      ...
      {filteredData.length === 0 && (
        <div className="text-center py-8">
          <p className="text-gray-500">No proofing records found</p>
        </div>
      )}

...
export const COLORS = {
 ...
 warning: {
  ...
  badge: 'bg-gray-100 text-slate-900 border border-gray-100',
 },
 error: {
  bg: 'bg-red-50',
  text: 'text-red-700',
 ...
 manager: {
  ...
  text: 'text-slate-900',
  border: 'border-gray-100',
  badge: 'bg-gray-50 text-slate-900 border border-gray-100',
 },
 staff: {
  bg: 'bg-sky-50',
  text: 'text-sky-700',
...
export const BUTTON_VARIANTS = {
 primary: 'px-6 py-3 bg-slate-800 text-white rounded-lg hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-800 focus:ring-offset-2 transition-all font-semibold tracking-wider',
...
export const INPUT_VARIANTS = {
 default: 'w-full px-5 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-800 focus:border-transparent bg-gray-50/50 transition-all leading-normal tracking-wide',

...
export const UnifiedButton: React.FC<UnifiedButtonProps> = ({
  ...
  const variantStyles = {
    primary: 'px-6 py-3 bg-amber-500 text-white rounded-lg hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-all font-semibold tracking-wider disabled:opacity-50 disabled:cursor-not-allowed',
    ...
    <div className="space-y-2">
      ...
      <input
        ...
        className={`
          ...
          focus:ring-amber-500 focus:border-transparent bg-gray-50/50 transition-all 

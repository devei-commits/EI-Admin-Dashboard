  ...
  return (
    <div className={`relative ${widthClass}`}>
      ...
      <input
        ...
        className={`w-full pl-10 pr-${showClear && value ? '8' : '4'} py-2.5 border border-amber-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-400 text-sm transition-all bg-white ${className}`}
        {...props}
      />
      {showClear && value && (
        <button

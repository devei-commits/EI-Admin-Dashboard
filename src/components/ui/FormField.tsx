...
export const inputClassName = 'w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-700 text-sm transition-all';

/** Standard select className for consistent styling */
export const selectClassName = 'w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-700 text-sm transition-all';

/** Standard textarea className for consistent styling */
export const textareaClassName = 'w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-700 text-sm transition-all resize-none';

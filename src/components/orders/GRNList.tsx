  ...
  <div className="w-full h-full flex flex-col">
   ...
   <div className="bg-slate-800 p-4 border-b border-slate-600">
    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
     <div className="flex items-center gap-4">
      ...
      <span className="text-sm text-slate-400">{selectedGRNs.length} Selected</span>
     </div>
    ...
    <table className="w-full text-xs border-collapse">
     <thead>
      <tr className="bg-gray-200 sticky top-0">
       ...
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">GRN No</th>
       ...
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">GRN Date</th>
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">Invoice No</th>
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">Prepared By</th>
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">Updated On</th>
       ...
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">Attachment</th>
     ...
     <tbody>
      {paginatedData.map((item) => (
       <tr key={item.id} className="hover:bg-slate-50 transition-colors">
        ...
        <td className="border border-slate-600 p-2 font-medium whitespace-nowrap">{item.grnNo}</td>
        <td className="border border-slate-600 p-2 whitespace-nowrap">{item.poNo}</td>
        <td className="border border-slate-600 p-2 max-w-xs truncate" title={item.vendor}>
         {item.vendor}
        </td>
        <td className="border border-slate-600 p-2 whitespace-nowrap">{item.grnDate || '-'}</td>
        <td className="border border-slate-600 p-2 whitespace-nowrap">{item.invoiceNo}</td>
        <td className="border border-slate-600 p-2 whitespace-nowrap">{item.preparedBy}</td>
        <td className="border border-slate-600 p-2 whitespace-nowrap">{item.updatedOn}</td>
     ...
     <div key={item.id} className="border border-slate-600 rounded-lg p-4 bg-white shadow-sm">
      <div className="flex items-start justify-between mb-3">
       ...
       <div className="flex-1 ml-3">
        ...
        <p className="text-xs text-slate-400 mt-1">PO: {item.poNo}</p>
       </div>
      </div>
      ...
      <div className="space-y-2 text-xs">
       ...
       <div className="flex justify-between">
        ...
        <span className="px-2 py-1 bg-gray-100 text-slate-300 rounded text-xs">{item.status}</span>
       </div>
       <div className="flex justify-between">
   ...
   {paginatedData.length === 0 && (
    <div className="text-center py-8">
     <p className="text-slate-500">No GRN records found</p>
    </div>
   )}

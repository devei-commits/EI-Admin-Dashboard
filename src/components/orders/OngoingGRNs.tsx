  ...
  <div className="w-full h-full flex flex-col">
    ...
    <table className="w-full text-xs border-collapse">
     <thead>
      <tr className="bg-gray-200 sticky top-0">
       ...
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">GRN_ID</th>
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">PO_No</th>
       <th className="border border-slate-600 p-2 text-left font-semibold">VendorName</th>
       ...
       <th className="border border-slate-600 p-2 text-left font-semibold whitespace-nowrap">AddedOn</th>
     ...
     <tbody>
      {paginatedData.map((item) => (
       <tr key={item.id} className="hover:bg-slate-50 transition-colors">
        ...
        <td className="border border-slate-600 p-2 font-medium whitespace-nowrap">{item.grnId}</td>
        <td className="border border-slate-600 p-2 whitespace-nowrap">{item.poNo}</td>
        <td className="border border-slate-600 p-2 max-w-xs truncate" title={item.vendorName}>
         {item.vendorName || '-'}
        </td>
        ...
        <td className="border border-slate-600 p-2 whitespace-nowrap">{item.addedOn}</td>
   ...
   {paginatedData.length === 0 && (
    <div className="text-center py-8">
     <p className="text-slate-500">No ongoing GRNs found</p>
    </div>
   )}

    ...
    <div className="flex items-center justify-center">
      <input
        ...
        className={`w-5 h-5 rounded border-2 transition-all duration-200 cursor-pointer
          ${checked ? 'bg-amber-500 border-amber-500 text-white' : 'bg-white border-gray-300'}
        ...
        <>
          ...
          <div className="flex flex-col gap-3 mb-4 sm:mb-6">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 sm:py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 bg-gray-50/50 text-base"
              />
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 -mx-2 px-2 scrollbar-hide">
              <select
                ...
                className="px-3 sm:px-4 py-2 sm:py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 bg-gray-50/50 text-sm whitespace-nowrap flex-shrink-0"
              >
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-50 rounded-lg text-xs sm:text-sm">
            <div className="flex items-center gap-1.5 sm:gap-2 text-gray-600">
              <div className="w-4 h-4 sm:w-5 sm:h-5 bg-amber-500 rounded"></div>
              <span>Enabled</span>
            </div>
            <div className="flex items-center gap-1.5 sm:gap-2 text-gray-600">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600">
              <div className="w-5 h-5 bg-amber-200 border-2 border-amber-400 rounded"></div>
              <span>Partial</span>
            </div>
          </div>
              ...
              return (
                <div
                  ...
                  className={`border rounded-xl overflow-hidden transition-all duration-200 ${
                    hasPermissions ? 'border-amber-200 bg-amber-50/30' : 'border-gray-200 bg-white'
                  }`}
                >
                  ...
                  <div
                    className={`flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 cursor-pointer transition-colors gap-3 ${
                      hasPermissions ? 'hover:bg-amber-50' : 'hover:bg-gray-50'
                    }`}
                    onClick={() => toggleModule(module.moduleId)}
                  >
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className={`p-1.5 sm:p-2 rounded-lg flex-shrink-0 ${hasPermissions ? 'bg-amber-100 text-amber-600' : 'bg-gray-100 text-gray-500'}`}>
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between px-3 sm:px-6 py-3 sm:py-4 gap-3">
                              <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                {hasAnyAccess && !hasFullAccess && (
                                  <span className="px-1.5 sm:px-2 py-0.5 text-[10px] sm:text-xs bg-amber-100 text-amber-700 rounded-full whitespace-nowrap">Partial</span>
                                )}
                              </div>
              ...
              {[
                ...
                <label key={key} className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                  <input
                    ...
                    disabled={readOnly}
                    className="w-5 h-5 mt-0.5 text-amber-500 rounded border-gray-300 focus:ring-amber-500"
                  />
                  <div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <label className="block">
              ...
              <input
                ...
                disabled={readOnly}
                className="mt-2 w-full max-w-xs px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 bg-gray-50/50"
              />

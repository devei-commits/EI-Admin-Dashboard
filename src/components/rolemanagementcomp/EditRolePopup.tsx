   ...
   <div className="bg-white rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] overflow-auto">
    ...
    <form onSubmit={handleSubmit} className="p-5 space-y-5">
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
       ...
       <select
        ...
        className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-800 focus:border-transparent bg-gray-50/50 transition-all"
        required
       >
      ...
      <div className="md:col-span-1">
       ...
       <textarea
        ...
        onChange={handleInputChange}
        rows={3}
        className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-800 focus:border-transparent bg-gray-50/50 transition-all resize-none"
     ...
     <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-5 border-t border-gray-100">
      ...
      <button
       type="submit"
       className="w-full sm:w-auto px-5 py-2.5 bg-slate-800 text-white rounded-lg hover:bg-slate-800 transition-colors font-medium"
      >
       Save Changes
      </button>
     </div>
